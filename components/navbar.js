...
const navbar = ({
  ...
  return (
    <header className=" container sticky top-0 z-40 text-gray-600 body-font ">
      ...
      <div
        ref={ref}
        className={`fixed top-0 right-0 z-50 transition-transform transform ${
          Object.keys(cart).length !== 0 ? "translate-x-0" : "translate-x-full"
        } flex flex-col h-screen max-w-md`}
      >
        <div className="relative inset-0 overflow-hidden bg-gray-500 bg-opacity-75 transition-opacity">
