      ...
      <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
        ...
        <div className="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
          <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
            <div className="flex rounded-2xl flex-col justify-start items-start  bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
            ...
            <div className="flex justify-center flex-col md:flex-row l items-stretch rounded-2xl w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
              <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 rounded-2xl space-y-6">
                ...
                <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-800 border-b pb-4">
                  <div className="flex justify-between w-full">
                    ...
                    <p className="text-base -300 leading-4 text-gray-800">
                      $56.00
                    </p>
                  </div>
                  <div className="flex justify-between items-center w-full">
                    <p className="text-base leading-4 text-gray-800">
                      Discount{" "}
                      <span className="bg-gray-800 p-1 text-xs font-medium dark:bg-white dark:text-gray-800 leading-3 text-gray-800">
                        STUDENT
                      </span>
                    </p>
                    <p className="text-base  leading-4 text-gray-800">
              ...
              <div className="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full rounded-2xl bg-gray-50  space-y-6">
                <h3 className="text-xl  font-semibold leading-5 text-gray-800">
                  Shipping
                </h3>
          ...
          <div className="bg-gray-50  w-full xl:w-96 flex justify-between items-center rounded-2xl md:items-start px-4 py-6 md:p-6 xl:p-8 flex-col">
            <h3 className="text-xl  font-semibold leading-5 text-gray-800">
              Customer
            </h3>
            <div className="flex flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0">
              ...
              <div className="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                ...
                <div className="flex w-full justify-center items-center md:justify-start md:items-start">
                  <button className="inline-flex items-center mx-3 drop-shadow-lg  rounded-md bg-purple-700 text-slate-50 border-0 py-2 px-5 font-bold text-lg focus:outline-none hover:bg-gray-100 hover:text-purple-800   hover:font-bold mt-4 md:mt-0">
                    Edit Details
                  </button>
                </div>
              </div>
